...
class FinestraCategories(tk.Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.quota_adult.set(categoria.fee)
        categoria=bd.llegir_categoria(2)
        self.quota_cadet.set(categoria.fee)
        categoria=bd.llegir_categoria(3)
        self.quota_juvenil.set(categoria.fee)
        categoria=bd.llegir_categoria(4)
        self.quota_infantil.set(categoria.fee)
        categoria=bd.llegir_categoria(5)
        self.quota_bebe.set(categoria.fee)
        bd.tancar_conexio()
        self.grab_set()
    ...
    def modificar(self):
        ...
        bd=BaseDeDades("falla.db")
        categoria=bd.llegir_categoria(1)
        categoria.fee=self.quota_adult.get()
        bd.actualitzar_categoria(categoria)
        categoria=bd.llegir_categoria(2)
        categoria.fee=self.quota_cadet.get()
        bd.actualitzar_categoria(categoria)
        categoria=bd.llegir_categoria(3)
        categoria.fee=self.quota_juvenil.get()
        bd.actualitzar_categoria(categoria)
        categoria=bd.llegir_categoria(4)
        categoria.fee=self.quota_infantil.get()
        bd.actualitzar_categoria(categoria)
        categoria=bd.llegir_categoria(5)
        categoria.fee=self.quota_bebe.get()
        bd.actualitzar_categoria(categoria)
        bd.tancar_conexio()